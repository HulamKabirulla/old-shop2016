...
<body style="background-color:#DCDCDC;margin: 0 !important;padding: 0 !important;">
    <div id="AllDiv">
        <div style="clear: left;float:left;background-color:black;width:100%;font-weight:100;margin-bottom:10px">
            ...
            <div style="float:left;color:white;margin-left:50px;padding:5px">
                <a href="contacts.php" style="color: white;">
        ...
        <div style="float: left;width:80%">
            ...
            <div style="clear: left;float:left;margin-left:50px;width:100%">
                ...
                {
                    $GoodsRow=$Goods->getGoodsByCategory($_GET['Category'],'');
                    $count=0;
                    for($i=0;$GoodsRow[$i];$i++)
                    {
                        $GoodsImg=$Goods->getGoodsMainImg($GoodsRow[$i]['id']);
                        if($count<3)
                        {
                        ...
                        else
                        {
                            ...
                            echo "<a href='GoodsDesc.php?good=".$GoodsRow[$i]['id']."'>";
                            ...
                            echo "<div style='clear:left;float:left;font-size:100%'>";
                                echo "<a href='GoodsDesc.php?good=".$GoodsRow[$i]['id']."' style='color:#1E90FF'>";
                                echo $GoodsRow[$i]['name'];
                                echo "</a>";
                            echo "</div>";
                            echo "<div style='clear:left;float:left'>";
                            echo "Цена: ";
                                echo "<font style='font-size:150%' id='".$GoodsRow[$i]['id']."_BasketPriceGood'>";
                                echo $GoodsRow[$i]['price'];
                                echo "</font>";
                            echo "грн";
                            echo "</div>";
                            echo "<div style='clear:left;float:left;width:40px;margin-top:20px;margin-bottom:5px'>";
                                echo "<input type='number' style='padding:5px;width:100%' value='1' id='".$GoodsRow[$i]['id']."_Count'/>";
                            echo "</div>";
                            echo "<div style='cursor:pointer;clear:left;float:left;padding:10px;background-color: #1E90FF;color:white;font-weight:bold;' class='AddToBasket' id='".$GoodsRow[$i]['id']."_AddToBasket'>";
                ...
                {
                    $GoodsRow=$Goods->getGoodsByName($_GET['search'],'');
                    $count=0;
                    for($i=0;$GoodsRow[$i];$i++)
                    {
                        $GoodsImg=$Goods->getGoodsMainImg($GoodsRow[$i]['id']);
                        ...
                        else
                        {
                            ...
                            echo "<div style='clear:left;float:left'>";
                            echo "Цена: ";
                                echo "<font style='font-size:150%'>";
                                echo $GoodsRow[$i]['price'];
                                echo "</font>";
                            echo "грн";
                            echo "</div>";
                            echo "<div style='clear:left;float:left;padding:10px;background-color: #1E90FF;color:white;font-weight:bold;'>";
                                echo "<font face=\"monospace\">В корзину</font>";
                            echo "</div>";
                        echo "</div>";
                        $count++;
