    ...
    <div id="AllDiv">
        ...
        <div style="float: left;width:80%">
            ...
            <div style="clear: left;float:left;margin-left:50px;width:100%">
                ...
                if(isset($_GET['good']))
                {
                    $GoodsRow=$Goods->getGoodsById($_GET['good'],'');
                    $count=0;
                    if($GoodsRow)
                    {
                        ...
                        else
                        {
                            ...
                            echo "<div style='clear:left;float:left;background-image:url(\"".$GoodsImg."\");width:500px;margin-top:10px;height:400px;background-size:contain;background-repeat:no-repeat;margin-right:10px'>";
                            echo "</div>";
                            echo "</a>";
                            ...
                            echo "</div>";
                            echo "</div>";
                            echo "<div style='clear:left;float:left;font-size:200%'>";
                                echo "Описание:";
                            echo "</div>";
                            echo "<div style='clear:left;float:left;font-size:150%;margin-top:20px'>";
                                echo htmlspecialchars($GoodsRow['description']);
                            echo "</div>";
                        echo "</div>";
                        $count++;
                    }
